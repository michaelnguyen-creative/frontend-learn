...
// Use type alias to declare a function type for sortDescending
type sortOrder = (a: number, b: number) => number
...
const sortDescending: sortOrder = (a, b) => {
if (a > b) {
    return -1;
} else if (b > a) {
    return 1;
...
const sortAscending: sortOrder = (a, b) => {
if (a > b) {
    return 1;
} else if (b > a) {
    return -1;
